...
def start_process(process_name):
    try:
        ...
        subprocess.Popen(["git", "-C", "/app", "pull", "https://github.com/gitHubUser82892/leafs-goal-light", "main"])
    except Exception as e:
    ...
    try:
        ...
        subprocess.Popen(["python3", "/app/goal_tracker.py"])  # You may need to include the full path
